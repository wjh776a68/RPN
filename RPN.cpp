...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance,
    ...
    LoadStringW(hInstance, IDC_RPN, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_RPN));
    MSG msg;
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDC_RPN));
    wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
    wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_RPN);
...
ATOM MyRegisterClass_SubWindows(HINSTANCE hInstance)
{
    ...
    childwcex.hIcon = LoadIcon(GetModuleHandle(NULL), MAKEINTRESOURCE(IDC_RPN));//参考文献: https://blog.csdn.net/baidu_24190413/article/details/47430551;
    ...
    childwcex.hIconSm = LoadIcon(childwcex.hInstance, MAKEINTRESOURCE(IDC_RPN));
...
void createLL1Windows(HWND mainwindows_hWnd) {
    ...
    TCHAR wordtext[] = TEXT("当前符号"), attribtext[] = TEXT("输入区"), typetext[] = TEXT("符号栈"), positiontext[] = TEXT("输出区");
...
void createFirstSetWindows(HWND mainwindows_hWnd) {
    ...
    tagLVCOLUMNW lvcolum;
    TCHAR wordtext[] = TEXT("优先级序号"), attribtext[] = TEXT("符号集合");
...
void SubWindows_SetGrammar(HWND mainwindows_hWnd) {
    subwindows_SETGRAMMER_hwnd = CreateWindowExW(0, L"childwin32app", TEXT("设置符号优先级\n"),
    ...
    SubWindows_button_SetGrammar = CreateWindowEx(0, L"BUTTON", L"保存优先级",
...
LRESULT CALLBACK WndProc_SubWindows(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_COMMAND:
    {
        ...
        case IDM_BUTTON_SETGRAMMAR:
            makeRPNCore.buildAnalyseSheet(str);
            break;
        }
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COMMAND:
    {
        ...
        case ID_FILE_RPN:
            ...
            makeRPNCore.BindInputHWND(main_RichTextBox_VAR);
            //CheckDACore.BindOutputHWND(main_underoutput_RichTextBox_VAR);
            makeRPNCore.BindOutputHWND(hwndList);
            makeRPNCore.makeRPN();
            break;
        ...
        case ID_MORE_RPN:
            ...
            break;
        case ID_MORE_PRIVILEGEWINDOW:
            StartFirstSetWindow(hWnd);
            makeRPNCore.BindoutputFirstSetHWND(hwndList_FirstSet);
            makeRPNCore.outputFirstSet();
            break;
